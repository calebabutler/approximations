...
sin: approx.c
	$(CC) $(CFLAGS) approx.c -DSIN -o sin

cos: approx.c
	$(CC) $(CFLAGS) approx.c -DCOS -o cos

atan: approx.c
	$(CC) $(CFLAGS) approx.c -DATAN -o atan

exp: approx.c
	$(CC) $(CFLAGS) approx.c -DEXP -o exp

log: approx.c
	$(CC) $(CFLAGS) approx.c -DLOG -o log

libm_sin: approx.c
	$(CC) $(CFLAGS) approx.c -DLIBM_SIN -lm -o libm_sin

libm_cos: approx.c
	$(CC) $(CFLAGS) approx.c -DLIBM_COS -lm -o libm_cos

libm_atan: approx.c
	$(CC) $(CFLAGS) approx.c -DLIBM_ATAN -lm -o libm_atan

libm_exp: approx.c
	$(CC) $(CFLAGS) approx.c -DLIBM_EXP -lm -o libm_exp

libm_log: approx.c
	$(CC) $(CFLAGS) approx.c -DLIBM_LOG -lm -o libm_log
