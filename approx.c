...
static double sin_stage_1(double);
static double sin_stage_2(double);
static double sin_stage_3(double);

static double atan_stage_1(double);
static double atan_stage_2(double);
static double Math_Atan(double);

static double exp2_stage_1(double);
static double Math_Exp2(double);

static double log2_stage_1(double);
static double Math_Log2(double);
...
double sin_stage_2(double x)
{
    double sin_6 = sin_stage_1(x * 4.0);
    return sin_6 * (3.0 - 4.0 * sin_6 * sin_6);
}


double sin_stage_3(double x)
{
    if (x < 0.25)
        return sin_stage_2(x);
    if (x < 0.5)
        return sin_stage_2(0.5 - x);
    if (x < 0.75)
        return -sin_stage_2(x - 0.5);
    return -sin_stage_2(1.0 - x);
}
...
double Math_Sin(double x)
{
    ...
    return sin_stage_3(x_div_pi - floord(x_div_pi));
}
...
double Math_Cos(double x)
{
    ...
    return sin_stage_3(x_div_pi_shifted - floord(x_div_pi_shifted));
}
...
double atan_stage_2(double x)
{
    ...
    if (R <= 1)
        return atan_stage_1(x);

    double t = div_x_i[R] - div_x_i_2_plus_1[R] / (div_x_i[R] + x);
    if (t >= 0)
        return (2 * R - 2) * PI / 32.0 + atan_stage_1(t);
...
double Math_Exp2(double x)
{
    ...
    return doi.d * SQRT2 * exp2_stage_1(x - (double) x_int - 0.5);
}
...
double Math_Log2(double x)
{
    ...
    return integer_part + log2_stage_1(doi.d);
}
